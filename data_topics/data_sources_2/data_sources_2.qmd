...
- [**Bureau of Labor Statistics](https://www.bls.gov/) - The BLS collects employment, inflation, and other information related to work, including the [American Time Use Study](https://www.bls.gov/tus/).
...
- [**Crime Data Explorer**](https://cde.ucr.cjis.gov/LATEST/webapp/#/pages/home) - represents the current information from the Federal Bureau of Investigation's [Uniform Crime Statistics](https://www.fbi.gov/how-we-can-help-you/more-fbi-services-and-information/ucr).
...
# Nonprofit organizations for data
...
# Commercial/subscription resources
...
- [**Sage Data**](https://www.libraries.rutgers.edu/databases/data-planet) - Sage Data lets you search a large collection of statistics from state, federal, international, and private sources and download extracts and graphs.
